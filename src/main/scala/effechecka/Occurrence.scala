...
case class OccurrenceRequest(selector: Selector, limit: Option[Int] = None, added: Option[DateTimeSelector] = Some(DateTimeSelector()))
...
case class OccurrenceMonitor(selector: Selector, status: Option[String], recordCount: Option[Int], lastModified: Long)
